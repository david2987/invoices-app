...
function search() {
    router.get('/services', { term: term.value }, { replace: true })
}
...
<template>
  ...
  <fwb-modal v-if="isShowModal" @close="closeModal">
    ...
    <template #body>
     <div>
        Are you sure you want to delete {{ idServiceDelete }}?
     </div>
    </template>
    <template #footer>
    ...
    <div class="container mx-auto" >
        ...
        <div class="container mx-auto mt-2">
            <table class="table-auto w-full">
                ...
                <tbody>
                <tr v-for="service in services.data" :key="service.id" class="border-b border-gray-200 hover:bg-gray-100">
